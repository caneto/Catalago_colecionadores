...
import '../../core/database/isar_models/line_collection.dart';
import '../../core/database/isar_service.dart';
import 'widgets/add_line_form.dart';
...
class _AddLinePageState extends State<AddLinePage> {
  ...
  String textAddOption = 'Adicionar Linha';
  String textButtonOption = 'Salvar Linha';
  ...
  void initState() {
    super.initState();
    _bloc = LineBloc(IsarService());
    if (widget.line != null) {
      _nameController.text = widget.line!.linha;
      _descriptionController.text = widget.line!.descricao ?? '';
      textAddOption = "Editar Linha";
      textButtonOption = "Editar Linha";
    }
  }
  ...
  void _onSave() {
    ...
    final line = widget.line ?? LineCollection();
    line
      ..linha = _nameController.text
      ..descricao = _descriptionController.text;

    _bloc.add(AddLine(line));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: _bloc,
      child: BlocListener<LineBloc, LineState>(
